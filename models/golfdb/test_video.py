...
if __name__ == '__main__':
    ...
    # 수정 (저장할 디렉토리)
    parser.add_argument('-d', '--save-path', type=str, default='outputs/')
    ...
    try:
        save_dict = torch.load('weight/swingnet_1800.pth.tar')
    except:
        print("Model weights not found. Download model weights and place in 'weight' folder. See README for instructions")
    ...
    for i, e in enumerate(events):
        ...
        img = yolo(frame=img, size=416, score_threshold=0.1, nms_threshold=0.2)
